#pragma once
#include <Arduino.h>
class Scheduler; class ValveManager; class TimeManager; class WeatherManager; class SmartControlManager;
...
public:
    ...
    void setSmartControlManager(SmartControlManager& smartControlManager);
    bool startProgram(uint8_t programIndex, bool automatic=false);
    bool stop();
    bool isRunning() const;
    bool isProgramRunning(uint8_t programIndex) const;
...
private:
    Scheduler* scheduler_=nullptr; ValveManager* valveManager_=nullptr; TimeManager* timeManager_=nullptr; WeatherManager* weatherManager_=nullptr; SmartControlManager* smartControlManager_=nullptr;
    ...
    void clearState(); bool allValvesIdleAndClosed() const; void checkAutomaticStart();
};
